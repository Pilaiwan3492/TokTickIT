...
| **API-20** | API | AC-14, FR-11 | Search Ticket Queue by ticket number, summary, or requester | HTTP 200 OK; returns only matching records | `server/tests/lab-03/staff-queue.api.test.ts` | `Passing` |
