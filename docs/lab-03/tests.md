...
| **API-10b** | API | AC-07, BR-28 | Repeated logout invocation with already revoked token | HTTP 200 OK; idempotent logout response with safe message | `server/tests/lab-03/auth.api.test.ts` | `Passing` |
